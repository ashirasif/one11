...
function HeroSection() {
  return (
    <div className="ml-12 flex w-3/6 flex-col items-start h-full justify-center gap-2 text-white">
      ...
      <h1 className="font-inter text-4xl font-bold leading-tight tracking-tighter">
