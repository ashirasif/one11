...
export default function Markup() {
  ...
  return (
    <div className='h-screen bg-stone-950 relative flex flex-col items-center justify-center'>
      ...
      <img ref={carRef} src="/Black-Car.png" className={cn('absolute top-[50%] transition-opacity duration-1000 brightness-200 translate-y-[-50%] w-2/4', carIsVisible ? "opacity-100" : "opacity-10")} alt="" />
    </div>
  )
}
