      ...
      <body>
        ...
        <div className="fixed bottom-4 right-4 z-30">
          <Link href="https://wa.me/971542793532" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 50 50" className="stroke-green-600 fill-black hover:fill-white/50 transition-colors duration-300">
